...
> Answer: We are given the ability to manage URL history on the client with no need to re-load the webpage. Data is loaded and re-renderd quickly and efficently using routers.
